...
<div class="content full-page adjacent-center">
    ...
    <form method="POST" action="{{ route('admin.user.account.update') }}" enctype="multipart/form-data"
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group" :class="[errors.has('password') ? 'has-error' : '']">
                            ...
                            <input type="password" name="password" class="control" id="password" ref="password"
                                v-validate="'min:6'" data-vv-as="{{ __('admin::app.user.account.password') }}" />
                        ...
                        <div class="form-group" :class="[errors.has('password_confirmation') ? 'has-error' : '']">
                            ...
                            <input type="password" name="password_confirmation" class="control" id="confirm_password"
