...
class PersonDataGrid extends DataGrid
{
    ...
    public function __construct()
    {
        ...
        $this->import = bouncer()->hasPermission('contacts.persons.import') ? true : false;
    }
    ...
    public function prepareActions()
    {
        ...
        if (bouncer()->hasPermission('contacts.persons.whatsapp')) {
            $this->addAction([
                'title'  => trans('whatsapp'),
                'method' => 'GET',
                'route'  => 'admin.contacts.persons.whatsapp',
                'icon'   => 'whatsapp-icon',
            ]);
        }
    }
